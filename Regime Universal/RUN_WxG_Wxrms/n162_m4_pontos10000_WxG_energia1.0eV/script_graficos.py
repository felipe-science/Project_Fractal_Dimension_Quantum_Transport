...
title("Condutância em função da desordem (E = 1.0 eV)", fontsize='16')
xlabel("W", fontsize='15')
ylabel("<G>", fontsize='15')
tick_params(labelsize=11)
grid(True)
savefig('G_1.0eV.png', format='png')
show()

scatter(W, rms, color='red')
title("rms(G) (E = 1.0 eV)", fontsize='16')
xlabel("W", fontsize='15')
ylabel("rms(G)", fontsize='15')
tick_params(labelsize=11)
grid(True)
savefig('rms_1.0eV.png', format='png')
show()