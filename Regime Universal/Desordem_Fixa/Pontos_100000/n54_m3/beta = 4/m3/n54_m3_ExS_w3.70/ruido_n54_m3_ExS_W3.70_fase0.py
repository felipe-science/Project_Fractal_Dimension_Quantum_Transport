...
def ShootNoise_E_desordemfixa(syst):
    ...
    salt = np.random.randint(2000000) # Seed
    t = time.time()
    f = open("SN_m"+str(Nf)+"_n"+str(L)+"fase0.dat","w")
    for E in energies:
        smatrix = kwant.smatrix(syst, energy=E, params=dict(salt=salt, W=W*sigma_0))
    ...
    os.system("mv SN_m3_n53fase0.dat    /content/drive/MyDrive/Documentos/Mestrado/Output_colab/beta4/output_desordemfixa_n54_m3_beta4/")
