...
data_beta1 = np.loadtxt("gamma_m_beta1.dat", float)
data_beta2 = np.loadtxt("gamma_m_beta2.dat", float)
data_beta4 = np.loadtxt("gamma_m_beta4.dat", float)
...
plt.grid(True)
plt.savefig("gamma_mG.png", dpi=200)
plt.show()