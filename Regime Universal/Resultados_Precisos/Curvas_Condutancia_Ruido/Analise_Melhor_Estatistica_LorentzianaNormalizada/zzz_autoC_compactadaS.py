...
lorentz0_beta1 = np.loadtxt("m0/S_beta1_m0/aaalorentz.dat", float)
lorentz1_beta1 = np.loadtxt("m1/S_beta1_m1/aaalorentz.dat", float)
lorentz2_beta1 = np.loadtxt("m2/S_beta1_m2/aaalorentz.dat", float)
lorentz3_beta1 = np.loadtxt("m3/S_beta1_m3/aaalorentz.dat", float)
lorentz4_beta1 = np.loadtxt("m4/S_beta1_m4/aaalorentz.dat", float)

points0_beta1 = np.loadtxt("m0/S_beta1_m0/aaapoints.dat", float)
points1_beta1 = np.loadtxt("m1/S_beta1_m1/aaapoints.dat", float)
points2_beta1 = np.loadtxt("m2/S_beta1_m2/aaapoints.dat", float)
points3_beta1 = np.loadtxt("m3/S_beta1_m3/aaapoints.dat", float)
points4_beta1 = np.loadtxt("m4/S_beta1_m4/aaapoints.dat", float)


# Carregar os dados beta2
lorentz0_beta2 = np.loadtxt("m0/S_beta2_m0/aaalorentz.dat", float)
lorentz1_beta2 = np.loadtxt("m1/S_beta2_m1/aaalorentz.dat", float)
lorentz2_beta2 = np.loadtxt("m2/S_beta2_m2/aaalorentz.dat", float)
lorentz3_beta2 = np.loadtxt("m3/S_beta2_m3/aaalorentz.dat", float)
lorentz4_beta2 = np.loadtxt("m4/S_beta2_m4/aaalorentz.dat", float)

points0_beta2 = np.loadtxt("m0/S_beta2_m0/aaapoints.dat", float)
points1_beta2 = np.loadtxt("m1/S_beta2_m1/aaapoints.dat", float)
points2_beta2 = np.loadtxt("m2/S_beta2_m2/aaapoints.dat", float)
points3_beta2 = np.loadtxt("m3/S_beta2_m3/aaapoints.dat", float)
points4_beta2 = np.loadtxt("m4/S_beta2_m4/aaapoints.dat", float)


# Carregar os dados beta2
lorentz0_beta4 = np.loadtxt("m0/S_beta4_m0/aaalorentz.dat", float)
lorentz1_beta4 = np.loadtxt("m1/S_beta4_m1/aaalorentz.dat", float)
lorentz2_beta4 = np.loadtxt("m2/S_beta4_m2/aaalorentz.dat", float)
lorentz3_beta4 = np.loadtxt("m3/S_beta4_m3/aaalorentz.dat", float)
lorentz4_beta4 = np.loadtxt("m4/S_beta4_m4/aaalorentz.dat", float)

points0_beta4 = np.loadtxt("m0/S_beta4_m0/aaapoints.dat", float)
points1_beta4 = np.loadtxt("m1/S_beta4_m1/aaapoints.dat", float)
points2_beta4 = np.loadtxt("m2/S_beta4_m2/aaapoints.dat", float)
points3_beta4 = np.loadtxt("m3/S_beta4_m3/aaapoints.dat", float)
points4_beta4 = np.loadtxt("m4/S_beta4_m4/aaapoints.dat", float)
...
alpha = 1.0101073315036557
gamma = 1.006986164509654
...
plt.title(r"Shot Noise Power", fontsize=35)
plt.savefig("autoC_S.png", dpi=250)
plt.show()
