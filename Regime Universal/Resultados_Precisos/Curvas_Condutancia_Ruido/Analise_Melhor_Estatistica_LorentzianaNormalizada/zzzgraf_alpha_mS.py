...
# Carregando os dados
data_G_beta1 = np.loadtxt("S_beta1_alphavsm.dat", float)
data_G_beta2 = np.loadtxt("S_beta2_alphavsm.dat", float)
data_G_beta4 = np.loadtxt("S_beta4_alphavsm.dat", float)
