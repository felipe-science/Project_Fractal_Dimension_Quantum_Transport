...
# Carregar os dados
lorentz0_beta1 = np.loadtxt("m0/S_beta2_m0/aaalorentz.dat", float)
lorentz1_beta1 = np.loadtxt("m1/S_beta2_m1/aaalorentz.dat", float)
lorentz2_beta1 = np.loadtxt("m2/S_beta2_m2/aaalorentz.dat", float)
lorentz3_beta1 = np.loadtxt("m3/S_beta2_m3/aaalorentz.dat", float)
lorentz4_beta1 = np.loadtxt("m4/S_beta2_m4/aaalorentz.dat", float)

points0_beta1 = np.loadtxt("m0/S_beta2_m0/aaapoints.dat", float)
points1_beta1 = np.loadtxt("m1/S_beta2_m1/aaapoints.dat", float)
points2_beta1 = np.loadtxt("m2/S_beta2_m2/aaapoints.dat", float)
points3_beta1 = np.loadtxt("m3/S_beta2_m3/aaapoints.dat", float)
points4_beta1 = np.loadtxt("m4/S_beta2_m4/aaapoints.dat", float)
...
plt.title(r"$\beta=2$", fontsize='24')
plt.savefig(r'compareSbeta2.png', dpi=200)
plt.show()
