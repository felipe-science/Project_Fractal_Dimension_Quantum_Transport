...
# =============================POINTS===============================
g_beta1_point = np.loadtxt("G_beta1_m4/aaapoints.dat", float)
g_beta2_point = np.loadtxt("G_beta2_m4/aaapoints.dat", float)
g_beta4_point = np.loadtxt("G_beta4_m4/aaapoints.dat", float)
s_beta1_point = np.loadtxt("S_beta1_m4/aaapoints.dat", float)
s_beta2_point = np.loadtxt("S_beta2_m4/aaapoints.dat", float)
s_beta4_point = np.loadtxt("S_beta4_m4/aaapoints.dat", float)
...
# =============================CURVE===============================
g_beta1_point = np.loadtxt("G_beta1_m4/aaalorentz.dat", float)
g_beta2_point = np.loadtxt("G_beta2_m4/aaalorentz.dat", float)
g_beta4_point = np.loadtxt("G_beta4_m4/aaalorentz.dat", float)
s_beta1_point = np.loadtxt("S_beta1_m4/aaalorentz.dat", float)
s_beta2_point = np.loadtxt("S_beta2_m4/aaalorentz.dat", float)
s_beta4_point = np.loadtxt("S_beta4_m4/aaalorentz.dat", float)
...
plt.title(r"$m = 4$", fontsize=22)  # Título
plt.tick_params(axis='both', which='major', labelsize=13)  # Fonte dos ticks

#plt.xlim(0, 0.0025)
plt.savefig("m4_lorentziana.png", dpi=300)
plt.show()
