...
g_beta4_point = np.loadtxt("G_beta4_m0/aaapoints.dat", float)
s_beta1_point = np.loadtxt("S_beta1_m0/aaapoints.dat", float)
s_beta2_point = np.loadtxt("S_beta2_m0/aaapoints.dat", float)
s_beta4_point = np.loadtxt("S_beta4_m0/aaapoints.dat", float)
...
g_beta4_point = np.loadtxt("G_beta4_m0/aaalorentz.dat", float)
s_beta1_point = np.loadtxt("S_beta1_m0/aaalorentz.dat", float)
s_beta2_point = np.loadtxt("S_beta2_m0/aaalorentz.dat", float)
s_beta4_point = np.loadtxt("S_beta4_m0/aaalorentz.dat", float)
