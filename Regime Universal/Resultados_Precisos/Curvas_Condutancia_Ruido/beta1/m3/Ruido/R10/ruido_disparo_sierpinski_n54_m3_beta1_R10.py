...
def ShootNoise_E_desordemfixa(syst):
    ...
    salt = np.random.randint(2000000) # Seed
    t = time.time()
    f = open("SN_m"+str(Nf)+"_n"+str(L)+"R10.dat","w")
    for E in energies:
        smatrix = kwant.smatrix(syst, energy=E, params=dict(salt=salt, W=W*sigma_0))
    ...
    #os.system("mv SN_m3_n53R5.dat    /content/drive/MyDrive/Documentos/output_colab/Curvas_Condutancia_Ruido/beta1/m3/Ruido/")
