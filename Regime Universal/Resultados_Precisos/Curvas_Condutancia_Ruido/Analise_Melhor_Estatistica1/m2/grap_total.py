...
# =============================POINTS===============================
g_beta1_point = np.loadtxt("G_beta1_m0/aaapoints.dat", float)
g_beta2_point = np.loadtxt("G_beta2_m0/aaapoints.dat", float)
g_beta4_point = np.loadtxt("G_beta4_m2/aaapoints.dat", float)
s_beta1_point = np.loadtxt("S_beta1_m2/aaapoints.dat", float)
s_beta2_point = np.loadtxt("S_beta2_m2/aaapoints.dat", float)
s_beta4_point = np.loadtxt("S_beta4_m2/aaapoints.dat", float)
...
# =============================CURVE===============================
g_beta1_point = np.loadtxt("G_beta1_m0/aaalorentz.dat", float)
g_beta2_point = np.loadtxt("G_beta2_m0/aaalorentz.dat", float)
g_beta4_point = np.loadtxt("G_beta4_m2/aaalorentz.dat", float)
s_beta1_point = np.loadtxt("S_beta1_m2/aaalorentz.dat", float)
s_beta2_point = np.loadtxt("S_beta2_m2/aaalorentz.dat", float)
s_beta4_point = np.loadtxt("S_beta4_m2/aaalorentz.dat", float)
...
plt.title(r"$m = 2$", fontsize=22)  # Título
plt.tick_params(axis='both', which='major', labelsize=13)  # Fonte dos ticks
plt.savefig("m2_lorentziana.png", dpi=300)
plt.show()
