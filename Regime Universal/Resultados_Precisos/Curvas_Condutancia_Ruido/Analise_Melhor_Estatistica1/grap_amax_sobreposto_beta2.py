...
# Carregar os dados
m0_g_beta1p = np.loadtxt("m0/G_beta2_m0/amax_point.dat", float)
m0_g_beta1c = np.loadtxt("m0/G_beta2_m0/amax_curve.dat", float)
...
m1_g_beta1p = np.loadtxt("m1/G_beta2_m1/amax_point.dat", float)
m1_g_beta1c = np.loadtxt("m1/G_beta2_m1/amax_curve.dat", float)
...
m2_g_beta1p = np.loadtxt("m2/G_beta2_m0/amax_point.dat", float)
m2_g_beta1c = np.loadtxt("m2/G_beta2_m0/amax_curve.dat", float)
...
m3_g_beta1p = np.loadtxt("m3/G_beta2_m3/amax_point.dat", float)
m3_g_beta1c = np.loadtxt("m3/G_beta2_m3/amax_curve.dat", float)
