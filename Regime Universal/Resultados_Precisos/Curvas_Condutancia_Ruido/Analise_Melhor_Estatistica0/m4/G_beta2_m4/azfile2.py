...
#Selecionandos os primeiros pontos da função de autocorrelação
NP = 70
...
def process_file(filename):
    ...
    data = data0[:NP]  # Se você deseja ajustar apenas os primeiros 30 pontos
    ...
    y_data = data
    x_data = np.linspace(0,NP*0.22/(len(data0)),len(y_data))
