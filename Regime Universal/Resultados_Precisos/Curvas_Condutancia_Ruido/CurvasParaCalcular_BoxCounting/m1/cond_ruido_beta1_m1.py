...
def main():
    ...
    for l in range(0,1,1):
        ...
        #os.system(f"mv G_m1_n54w167_R{l}.dat    /content/drive/MyDrive/Pesquisa/Resultados_Artigo1/G_beta1_m1")
        #os.system(f"mv S_m1_n54w167_R{l}.dat    /content/drive/MyDrive/Pesquisa/Resultados_Artigo1/S_beta1_m1")
