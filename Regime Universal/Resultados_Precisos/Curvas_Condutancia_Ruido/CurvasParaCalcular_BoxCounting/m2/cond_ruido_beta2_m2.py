...
def main():
    ...
    for l in range(0,1,1):
        ...
        #os.system(f"mv G_m2_n54w298_R{l}.dat    /content/drive/MyDrive/Pesquisa/outputArtigo1/G_beta2_m2")
        #os.system(f"mv S_m2_n54w298_R{l}.dat    /content/drive/MyDrive/Pesquisa/outputArtigo1/S_beta2_m2")
