...
def main():
    ...
    for l in range(0,1,1):
        ...
        #os.system(f"mv G_m3_n53w08_R{l}.dat /content/drive/MyDrive/Pesquisa/Resultados_Artigo1/G_beta1_m3")
        #os.system(f"mv S_m3_n53w08_R{l}.dat /content/drive/MyDrive/Pesquisa/Resultados_Artigo1/S_beta1_m3")
