...
def G_E_desordemfixa(syst,l):
    ...
    f = open(f"G_m{Nf}_beta4.dat","w")
    g = open(f"S_m{Nf}_beta4.dat","w")
    for E in energies:
        ...
        cont+=1
        if(cont % 200 == 0):
            print(f"run = {100*cont/100000.0}%   time = {total_time/3600.0}")
    ...
    #os.system("mv G_m4_n161fase0.dat    /content/drive/MyDrive/Documentos/output_colab/Output_Condutancia_Ruido_Curvas/beta4/m4/Condutancia/")
...
def main():
    ...
    for l in range(0,1,1):
        ...
        #os.system(f"mv G_m4_n161w284_R{l}.dat    /content/drive/MyDrive/Pesquisa/Resultados_Artigo1/m4/Gbeta4C")
        #os.system(f"mv S_m4_n161w284_R{l}.dat    /content/drive/MyDrive/Pesquisa/Resultados_Artigo1/m4/Sbeta4C")
