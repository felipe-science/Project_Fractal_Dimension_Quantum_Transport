...
def main():
    ...
    for l in range(0,1,1):
        ...
        #os.system(f"mv G_m4_n161w036_R{l}.dat    /content/drive/MyDrive/Pesquisa/outputArtigo1/G_beta1_m4")
        #os.system(f"mv S_m4_n161w036_R{l}.dat    /content/drive/MyDrive/Pesquisa/outputArtigo1/S_beta1_m4")
