...
plt.plot(x_beta1, y_beta1, color='blue', label=r'$\beta = 1$')
plt.plot(x_beta2, y_beta2, color='red', label=r'$\beta = 2$')
plt.plot(x_beta4, y_beta4, color='green', label=r'$\beta = 4$')
...
plt.savefig("ordem2.png", dpi=200)
plt.show()