...
#    os.system(("mv G%i.dat    /content/drive/MyDrive/Documentos/output_n54_m3_beta2_phi5/")%(i))
    t = time.time()-t
    print(("Simulation = %i, Time = %i s = %f min")%(i,t,t/60))

    print(f"\nNúmero de modos para E =",{E},"eV:",smatrix.num_propagating(0))

def G_E(syst):
    for i in range(1207,5000,1):
        try:
