...
# Carregar os dados
rmsG_m0_b1 = np.loadtxt("rmsG_m0_b1.dat", float)
rmsG_m1_b1 = np.loadtxt("rmsG_m1_b1.dat", float)
rmsG_m2_b1 = np.loadtxt("rmsG_m2_b1.dat", float)
rmsG_m3_b1 = np.loadtxt("rmsG_m3_b1.dat", float)
rmsG_m4_b1 = np.loadtxt("rmsG_m4_b1.dat", float)

rmsG_m0_b2 = np.loadtxt("rmsG_m0_b2.dat", float)
rmsG_m1_b2 = np.loadtxt("rmsG_m1_b2.dat", float)
rmsG_m2_b2 = np.loadtxt("rmsG_m2_b2.dat", float)
rmsG_m3_b2 = np.loadtxt("rmsG_m3_b2.dat", float)
rmsG_m4_b2 = np.loadtxt("rmsG_m4_b2.dat", float)

rmsG_m0_b4 = np.loadtxt("rmsG_m0_b4.dat", float)
rmsG_m1_b4 = np.loadtxt("rmsG_m1_b4.dat", float)
rmsG_m2_b4 = np.loadtxt("rmsG_m2_b4.dat", float)
rmsG_m3_b4 = np.loadtxt("rmsG_m3_b4.dat", float)
rmsG_m4_b4 = np.loadtxt("rmsG_m4_b4.dat", float)
...
axs[0].set_ylabel(r"$rms(G)$", fontsize=20)
...
axs[1].set_ylabel(r"$rms(G)$", fontsize=20)
...
axs[2].set_ylabel(r"$rms(G)$", fontsize=20)
...
# Ajustar o layout
plt.tight_layout()
plt.savefig("img_rmsG.png", dpi=300)
plt.show()
