...
plt.scatter(data_m0_beta1_G[:,0], data_m0_beta1_G[:,1], label=r'$m = 0$', s=100, marker='o')  
plt.scatter(data_m1_beta1_G[:,0], data_m1_beta1_G[:,1], label=r'$m = 1$', s=100, marker='s')  
plt.scatter(data_m2_beta1_G[:,0], data_m2_beta1_G[:,1], label=r'$m = 2$', s=100, marker='^')  
plt.scatter(data_m3_beta1_G[:,0], data_m3_beta1_G[:,1], label=r'$m = 3$', s=100, marker='D')  
plt.scatter(data_m4_beta1_G[:,0], data_m4_beta1_G[:,1], label=r'$m = 4$', s=100, marker='v')  



plt.plot(data_m0_beta1_G[:,0], data_m0_beta1_G[:,1], linewidth=2)
plt.plot(data_m1_beta1_G[:,0], data_m1_beta1_G[:,1], linewidth=2)
plt.plot(data_m2_beta1_G[:,0], data_m2_beta1_G[:,1], linewidth=2)
plt.plot(data_m3_beta1_G[:,0], data_m3_beta1_G[:,1], linewidth=2)
plt.plot(data_m4_beta1_G[:,0], data_m4_beta1_G[:,1], linewidth=2)
