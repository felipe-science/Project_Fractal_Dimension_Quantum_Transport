...
#Beta1
axes[0,0].plot(data_m0_beta1_G[:,0], data_m0_beta1_G[:,1], label=r'$m = 0$')
axes[0,0].plot(data_m1_beta1_G[:,0], data_m1_beta1_G[:,1], label=r'$m = 1$')
axes[0,0].plot(data_m2_beta1_G[:,0], data_m2_beta1_G[:,1], label=r'$m = 2$')
axes[0,0].plot(data_m3_beta1_G[:,0], data_m3_beta1_G[:,1], label=r'$m = 3$')
axes[0,0].plot(data_m4_beta1_G[:,0], data_m4_beta1_G[:,1], label=r'$m = 4$')
axes[0,0].set_title(r'$\beta = 1$', fontsize='22')
axes[0,0].set_xlabel(r'$W$', fontsize='18')
axes[0,0].legend(loc='best', fontsize='14')

#Beta1
axes[0,1].plot(data_m0_beta2_G[:,0], data_m0_beta2_G[:,1], label=r'$m = 0$')
axes[0,1].plot(data_m1_beta2_G[:,0], data_m1_beta2_G[:,1], label=r'$m = 1$')
axes[0,1].plot(data_m2_beta2_G[:,0], data_m2_beta2_G[:,1], label=r'$m = 2$')
axes[0,1].plot(data_m3_beta2_G[:,0], data_m3_beta2_G[:,1], label=r'$m = 3$')
axes[0,1].plot(data_m4_beta2_G[:,0], data_m4_beta2_G[:,1], label=r'$m = 4$')
axes[0,1].set_title(r'$\beta = 2$', fontsize='22')
axes[0,1].set_xlabel(r'$W$', fontsize='18')
axes[0,1].legend(loc='best', fontsize='14')

#Beta1
axes[0,2].plot(data_m0_beta4_G[:,0], data_m0_beta4_G[:,1], label=r'$m = 0$')
axes[0,2].plot(data_m1_beta4_G[:,0], data_m1_beta4_G[:,1], label=r'$m = 1$')
axes[0,2].plot(data_m2_beta4_G[:,0], data_m2_beta4_G[:,1], label=r'$m = 2$')
axes[0,2].plot(data_m3_beta4_G[:,0], data_m3_beta4_G[:,1], label=r'$m = 3$')
axes[0,2].plot(data_m4_beta4_G[:,0], data_m4_beta4_G[:,1], label=r'$m = 4$')
axes[0,2].set_title(r'$\beta = 4$', fontsize='22')
axes[0,2].set_xlabel(r'$W$', fontsize='18')
...
axes[1,0].set_title(r'$\beta = 1$', fontsize='22')
axes[1,0].set_xlabel(r'$W$', fontsize='18')
...
axes[1,1].set_title(r'$\beta = 2$', fontsize='22')
axes[1,1].set_xlabel(r'$W$', fontsize='18')
...
axes[1,2].set_title(r'$\beta = 4$', fontsize='22')
axes[1,2].set_xlabel(r'$W$', fontsize='18')
axes[1,2].legend(loc='best', fontsize='14')
