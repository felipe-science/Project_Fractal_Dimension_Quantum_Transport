...
def main():
    ...
    for l in range(0,1,1):
        ...
        #os.system(f"mv G_m0_n54w395_R{l}.dat    /content/drive/MyDrive/Pesquisa/NovosDados_Artigo1/G_beta2_m0")
        #os.system(f"mv S_m0_n54w395_R{l}.dat    /content/drive/MyDrive/Pesquisa/NovosDados_Artigo1/S_beta2_m0")
