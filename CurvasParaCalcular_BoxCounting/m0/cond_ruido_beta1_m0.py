...
def G_E_desordemfixa(syst,l):
    ...
    f = open(f"G_m{Nf}_beta1.dat","w")
    g = open(f"S_m{Nf}_beta1.dat","w")
    for E in energies:
...
def main():
    ...
    for l in range(0,1,1):
        ...
        #os.system(f"mv G_m0_n54w172_R{l}.dat    /content/drive/MyDrive/Pesquisa/NovosDados_Artigo1/G_beta1_m0")
        #os.system(f"mv S_m0_n54w172_R{l}.dat    /content/drive/MyDrive/Pesquisa/NovosDados_Artigo1/S_beta1_m0")
