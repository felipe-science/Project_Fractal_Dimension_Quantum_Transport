...
def G_E_desordemfixa(syst, l):
    ...
    salt = np.random.randint(2000000) # Seed
    t = time.time()
    f = open(f"G_m{Nf}_beta2.dat","w")
    g = open(f"S_m{Nf}_beta2.dat","w")
    for E in energies:
...
def main():
    ...
    for l in range(0,1,1):
        ...
        #os.system(f"mv G_m3_n53w213_R{l}.dat /content/drive/MyDrive/Pesquisa/Resultados_Artigo1/G_beta2_m3")
        #os.system(f"mv S_m3_n53w213_R{l}.dat /content/drive/MyDrive/Pesquisa/Resultados_Artigo1/S_beta2_m3")
