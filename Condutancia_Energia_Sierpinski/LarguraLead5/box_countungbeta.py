from numpy import loadtxt, linspace, log10, log
...
def box_counting(dadosx, dadosy):
    ...
    while(l >= 0.0125):
        ...
        print("l = ",l,"     n = ",n,"    Nºcx = ",contagem,"    L",l*L,"    D = ",(log10(contagem)/log10(1/l)))
        l = l/2

    # Calculando os logarítmos
    for k in range(len(comprl)):
        l_log = log10(1/comprl[k])
        n_log = log10(numecx[k])
...
data = loadtxt("G_m3_n53pts100000.dat",float)
datax = data[:,0]
datay = data[:,1]
