...
for k in range(NN):
    datax[k] = datax[k]/1
    #datax[k] = datax[k]/0.0004480644048644082
    datax[k] = datax[k]/0.0016904790032570307
...
popt, _ = curve_fit(f, datax, datay, p0=initial_guess, bounds=([1e-10, 0, 0], [np.inf, 4, np.inf]))
