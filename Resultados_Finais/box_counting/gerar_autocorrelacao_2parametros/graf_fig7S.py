...
data0G = np.loadtxt("m0/beta1/outputS/aaalorentz.dat", float)
data1G = np.loadtxt("m1/beta1/outputS/aaalorentz.dat", float)
data2G = np.loadtxt("m2/beta1/outputS/aaalorentz.dat", float)
data3G = np.loadtxt("m3/beta1/outputS/aaalorentz.dat", float)
data4G = np.loadtxt("m4/beta1/outputSn/aaalorentz.dat", float)
...
y1, y2 = 0.79, 0.87   # limites do eixo Y
...
ax.set_title('Shot Noise Power', fontsize=30)
