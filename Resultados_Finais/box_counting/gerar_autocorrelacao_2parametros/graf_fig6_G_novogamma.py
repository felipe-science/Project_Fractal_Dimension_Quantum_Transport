...
gamma = [0.00016354161608604713, 0.0001740, 0.000186361, 0.00014704, 0.00012142]
...
data4 = np.loadtxt("m4/beta1/nova_simulacao/outputG/G44.dat")
...
axes[2].plot(E0/gamma[0], G0, zorder=0)
axes[2].scatter(E0[peaks0]/gamma[0], G0[peaks0], color='red', zorder=1)
axes[2].set_title(rf"$m = 0$; $\Gamma = {round(gamma[0],6)}$")
...
axes[0].plot(E2/gamma[2], G2, zorder=0)
axes[0].scatter(E2[peaks2]/gamma[2], G2[peaks2], color='red', zorder=1)
axes[0].set_title(rf"$m = 2$; $\Gamma = {round(gamma[2],6)}$")
