...
# Carregar os dados
lorentz0_beta1 = np.loadtxt("m0/G_beta4_m0/aaalorentz.dat", float)
lorentz1_beta1 = np.loadtxt("m1/G_beta4_m1/aaalorentz.dat", float)
lorentz2_beta1 = np.loadtxt("m2/G_beta4_m2/aaalorentz.dat", float)
lorentz3_beta1 = np.loadtxt("m3/G_beta4_m3/aaalorentz.dat", float)
lorentz4_beta1 = np.loadtxt("m4/G_beta4_m4/aaalorentz.dat", float)

'''
points0_beta1 = np.loadtxt("m0/G_beta1_m0/aaapoints.dat", float)
points1_beta1 = np.loadtxt("m1/G_beta1_m1/aaapoints.dat", float)
points2_beta1 = np.loadtxt("m2/G_beta1_m0/aaapoints.dat", float)
...
plt.savefig("compareGbeta4.png", dpi=200)
plt.show()
