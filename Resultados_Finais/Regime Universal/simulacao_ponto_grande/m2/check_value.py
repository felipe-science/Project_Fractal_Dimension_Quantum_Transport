...
plt.scatter(x_beta1, y_beta1, color='blue', marker='*', label=r'$\beta = 1$')
plt.scatter(x_beta2, y_beta2, color='red', marker='s', facecolors='none', label=r'$\beta = 2$')
plt.scatter(x_beta4, y_beta4, color='green', marker='^', facecolors='none', label=r'$\beta = 4$')
